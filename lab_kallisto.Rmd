...
<i class="fas fa-exclamation-circle"></i> You do not need to run Kallisto to follow this tutorial as part of this course. This takes over an hour to run for all samples. Therefore, pre-computed output is provided for you. This is provided in the next section on Sleuth.

Of course, you will have to run these steps if you work with your own data.
</div>

Download and install [Kallisto](https://pachterlab.github.io/kallisto/download).
