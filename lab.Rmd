...
This topic covers retrieving annotation data needed for RNA-seq analyses. These include gene annotation IDs such as mapping between Ensembl IDs and Gene IDs, GO terms and transcript IDs. We also cover retrieving genomic data from Ensembl and GEO.

[<i class="fas fa-link"></i> <span class="large">Retrieving annotation data</span>](lab_download.html)
...
We will perform gene-set analysis on the differentially expressed genes to place them into a function context and explain biological consequences of DE.

[<i class="fas fa-link"></i> <span class="large">Gene set analysis</span>]()
